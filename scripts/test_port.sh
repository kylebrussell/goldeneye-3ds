...
python3 "${repo_dir}/scripts/tests/test_glass_gpu_alpha.py"
python3 "${repo_dir}/scripts/tests/test_renderer_fragment_contract.py"
python3 "${repo_dir}/scripts/tests/test_windowed_door_material_publication.py"
python3 "${repo_dir}/scripts/tests/test_windowed_door_shading.py"
...
python3 "${repo_dir}/scripts/tests/test_audio_ramp_bounds.py"
python3 "${repo_dir}/scripts/tests/test_audio_envelope_stable.py"
python3 "${repo_dir}/scripts/tests/test_audio_big_endian_store.py"
python3 "${repo_dir}/scripts/tests/test_native_model_hit_vertices.py"
python3 "${repo_dir}/scripts/tests/test_music_worker.py"
python3 "${repo_dir}/scripts/tests/test_music_runtime_handoff.py"
python3 "${repo_dir}/scripts/tests/test_sfx_decode_exact.py"
...
python3 "${repo_dir}/scripts/tests/test_articulated_pose_publication.py"
python3 "${repo_dir}/scripts/tests/test_model_topology_storage.py"
python3 "${repo_dir}/scripts/tests/test_first_person_layout_publication.py"
python3 "${repo_dir}/scripts/tests/test_renderer_batch_runs.py"
python3 "${repo_dir}/scripts/tests/test_renderer_visible_runs.py"
python3 "${repo_dir}/scripts/tests/test_renderer_prepared_world_runs.py"
bash "${repo_dir}/scripts/test_gun_sight.sh"
...
python3 "${repo_dir}/scripts/tests/test_3ds_frame_timing_analysis.py"
python3 "${repo_dir}/scripts/tests/test_3ds_probe_replay.py"
python3 "${repo_dir}/scripts/tests/test_3ds_gpu_commands.py"
python3 "${repo_dir}/scripts/tests/test_3ds_draw_sequence.py"
python3 "${repo_dir}/scripts/tests/test_3ds_shade_cache.py"
python3 "${repo_dir}/scripts/tests/test_model_segment_publication.py"
